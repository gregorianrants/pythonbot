class PIDController:
   def __init__(self, 
      ...
      self.proportional_constant = self.deg_per_second_to_mm_per_second(proportional_constant)
      self.integral_constant = self.deg_per_second_to_mm_per_second(integral_constant)
      self.derivative_constant = self.deg_per_second_to_mm_per_second(derivative_constant)
      # Running sums
      self.integral_sum = 0
      self.previous = 0
